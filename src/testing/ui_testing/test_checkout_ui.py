...
checkout_ui_cases = [tc for tc in read_test_cases('Payment') if tc["Loại test case"] == "UI"]
@pytest.mark.parametrize("test_case", checkout_ui_cases)
def test_ui_login(test_case):
    with sync_playwright() as p:
        ...
        page.fill("input[name='email']", "tester1@gmail.com")
        page.fill("input[name='password']", "123456")
        page.click("button.btn.btn-primary")

        page.wait_for_load_state("networkidle")
        page.goto('http://localhost/ecommerce/checkout')
